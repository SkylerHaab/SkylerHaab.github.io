$(function () {
  ...
  function setup() {
    ...
    createCollectable('database', 1310, 407, 0, 0);
    createCollectable('max', 140, 153, 0, 0);
    createCollectable('steve', 1310, 250, 0, 0);
    createCollectable('diamond', 875, 153, 0, 0);
    ...
    createCannon('bottom', 200, 1000, 25, 25)
    createCannon('bottom', 800, 1000, 25, 25)
    createCannon('bottom', 500, 1000, 25, 25)
    createCannon('bottom', 1200, 1000, 25, 25)
